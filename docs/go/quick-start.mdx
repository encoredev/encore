...
Through the Local Development Dashboard you also have access to [Encore Flow](/docs/go/develop/encore-flow),
...
You can now deploy this anywhere you like. Learn more in the [self-host docs](/docs/self-host/docker-build).
...
You can now use the Cloud Dashboard to view production [traces](/docs/observability/tracing), [connect your cloud account](/docs/deploy/own-cloud), [integrate with GitHub](/docs/how-to/github), and much more.
