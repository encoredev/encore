...
And you should see the "The Hobbit" in the list of books.

🥐 Try opening the Local Development Dashboard at [http://localhost:9400](http://localhost:9400) and view the traces that got generated when calling your GraphQL API.
