...
You can verify that the database was created by looking at your applications Flow architecture diagram in the local development dashboard at [localhost:9400](http://localhost:9400), which should look like this:
...
<video autoPlay playsInline loop controls muted className="w-full h-full">
  <source src="/assets/docs/rest_tut3.mp4" className="w-full h-full" type="video/mp4"/>
</video>
...
<video autoPlay playsInline loop controls muted className="w-full h-full">
  <source src="/assets/docs/rest_tut4.mp4" className="w-full h-full" type="video/mp4"/>
</video>
