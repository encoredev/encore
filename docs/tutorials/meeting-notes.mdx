...
subtitle: Learn how to set up web app backend (with database) in less than 100 lines of code
...
**[Demo version of the app](https://encoredev.github.io/example-meeting-notes)**

<video autoPlay playsInline loop controls muted className="w-full h-full">
	<source src="/assets/docs/meeting-notes-demo.mp4" className="w-full h-full" type="video/mp4" />
</video>
...
To create a SQL database using Encore we first create a folder named `migrations` and inside that folder a migration file named 1_create_tables.up.sql. The file name is important (it must look something like 1_&lt;name&gt;.up.sql). Our migration file is only five lines long and looks like this:
...
<video autoPlay playsInline loop controls muted className="w-full h-full">
	<source src="/assets/docs/meeting-notes-git-push.mp4" className="w-full h-full" type="video/mp4" />
</video>
...
2. Go to *Settings* → *Pages* for your repo on GitHub and set *Branch* to `gh-pages`.
