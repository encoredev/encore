...
[TanStack Query](https://tanstack.com/query/latest) is a popular library that was built to solve exactly these problems and works
really well together the Encore request client.

Here is a simple example of using the Encore request client together with TanStack Query:
