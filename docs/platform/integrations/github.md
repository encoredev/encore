...
To link your application to GitHub, open your application in the [Encore Cloud dashboard](https://app.encore.dev), and click on **Settings** in the main navigation.
...
Do this by opening your app in the [Encore Cloud dashboard](https://app.encore.dev) and go to **Settings** > **General**. Then in the **Root Directory** section, you specify the directory within your Git repository in which your `encore.app` file is located.
