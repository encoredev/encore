...
Encore gives AI coding assistants superpowers. With Encore-specific rules and MCP integration, AI understands your architecture, generates type-safe code that follows your patterns, and can provision infrastructure, whether [self-hosted](/docs/ts/self-host/build) or via [Encore Cloud](https://encore.cloud) in AWS/GCP with automatic guardrails.
...
- **Provision infrastructure** - databases, pub/sub, secrets, whether [self-hosted](/docs/ts/self-host/build) or via [Encore Cloud](https://encore.cloud) in AWS/GCP
