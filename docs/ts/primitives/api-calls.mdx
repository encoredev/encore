...
When compiling your application, Encore uses [static analysis](/docs/concepts/application-model) to parse all APIs and make then available through the `~encore/clients` module for internal calls.
