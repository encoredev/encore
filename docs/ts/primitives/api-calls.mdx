...
Calling an API endpoint looks like a regular function call with Encore.ts. To call an endpoint you first need to import the service from `encore.app/clients` and then call the API endpoint like a regular function.
