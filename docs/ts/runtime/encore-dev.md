...
### APICallMeta [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/req_meta.ts#L33)
...
### APIDesc [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/req_meta.ts#L4)
...
### AppMeta [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/app_meta.ts#L4)
...
### BaseRequestMeta [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/req_meta.ts#L145)
...
### BuildMeta [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/app_meta.ts#L72)
...
### DeployMeta [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/app_meta.ts#L81)
...
### EnvironmentMeta [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/app_meta.ts#L32)
...
### HostedService [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/app_meta.ts#L89)
...
### PubSubMessageMeta [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/req_meta.ts#L87)
...
### TraceData [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/req_meta.ts#L120)
...
### CloudProvider [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/app_meta.ts#L64)
...
### EnvironmentType [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/app_meta.ts#L53)
...
<!-- symbol-start: Method -->
### Method [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/req_meta.ts#L21)
...
### RequestMeta [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/req_meta.ts#L151)
...
<!-- symbol-start: appMeta() -->
### appMeta() [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/app_meta.ts#L100)
...
### currentRequest() [source](https://github.com/encoredev/encore/blob/main/runtimes/js/encore.dev/req_meta.ts#L160)
