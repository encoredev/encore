...
Open your AI coding tool and ask it to migrate your existing app. If you already have an Encore project, open the tool in that directory and point to where your source app lives:

```
Migrate my Express app at ../my-api to Encore.ts
```

If you don't have an Encore project yet, you can start from your source app's directory — the skill will help you create one:

```
Migrate this app to Encore.ts
```
