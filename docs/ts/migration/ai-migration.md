...
Or, if you already have Encore skills set up via `encore llm-rules init`, the migration skill is included automatically.
...
Open your AI coding tool in the Encore project directory and ask it to migrate your existing app:

```
Migrate my Express app at ../my-api to Encore.ts
```

```
I want to move my Node.js backend at /path/to/app to Encore
```
