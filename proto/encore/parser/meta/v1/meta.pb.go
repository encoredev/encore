...
var file_encore_parser_meta_v1_meta_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x22, 0xa1, 0x01, 0x0a, 0x04, 0x50, 0x61,
	...
	0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61, 0x74, 0x68, 0x2e, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x23, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65,
	0x12, 0x07, 0x0a, 0x03, 0x55, 0x52, 0x4c, 0x10, 0x00, 0x12, 0x12, 0x0a, 0x0e, 0x43, 0x41, 0x43,
	0x48, 0x45, 0x5f, 0x4b, 0x45, 0x59, 0x53, 0x50, 0x41, 0x43, 0x45, 0x10, 0x01, 0x22, 0x84, 0x03,
	...
	0x10, 0x01, 0x22, 0xef, 0x01, 0x0a, 0x0c, 0x43, 0x61, 0x63, 0x68, 0x65, 0x43, 0x6c, 0x75, 0x73,
	...
	0x65, 0x76, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x1a, 0x44,
	0x0a, 0x08, 0x4b, 0x65, 0x79, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x38, 0x0a, 0x08, 0x6b, 0x65,
	0x79, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x65,
	0x6e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x61, 0x72, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x07, 0x6b, 0x65, 0x79,
	0x54, 0x79, 0x70, 0x65, 0x42, 0x26, 0x5a, 0x24, 0x65, 0x6e, 0x63, 0x72, 0x2e, 0x64, 0x65, 0x76,
...
var file_encore_parser_meta_v1_meta_proto_goTypes = []interface{}{
	...
	(*Path)(nil),                       // 27: encore.parser.meta.v1.Path
	(*PathSegment)(nil),                // 28: encore.parser.meta.v1.PathSegment
	(*CronJob)(nil),                    // 29: encore.parser.meta.v1.CronJob
	(*PubSubTopic)(nil),                // 30: encore.parser.meta.v1.PubSubTopic
	(*CacheCluster)(nil),               // 31: encore.parser.meta.v1.CacheCluster
	(*PubSubTopic_Publisher)(nil),      // 32: encore.parser.meta.v1.PubSubTopic.Publisher
	(*PubSubTopic_Subscription)(nil),   // 33: encore.parser.meta.v1.PubSubTopic.Subscription
	(*PubSubTopic_RetryPolicy)(nil),    // 34: encore.parser.meta.v1.PubSubTopic.RetryPolicy
	(*CacheCluster_Keyspace)(nil),      // 35: encore.parser.meta.v1.CacheCluster.Keyspace
	(*v1.Decl)(nil),                    // 36: encore.parser.schema.v1.Decl
	(*v1.Type)(nil),                    // 37: encore.parser.schema.v1.Type
	(*v1.Loc)(nil),                     // 38: encore.parser.schema.v1.Loc
}
var file_encore_parser_meta_v1_meta_proto_depIdxs = []int32{
	36, // 0: encore.parser.meta.v1.Data.decls:type_name -> encore.parser.schema.v1.Decl
	...
	29, // 4: encore.parser.meta.v1.Data.cron_jobs:type_name -> encore.parser.meta.v1.CronJob
	30, // 5: encore.parser.meta.v1.Data.pubsub_topics:type_name -> encore.parser.meta.v1.PubSubTopic
	16, // 6: encore.parser.meta.v1.Data.middleware:type_name -> encore.parser.meta.v1.Middleware
	31, // 7: encore.parser.meta.v1.Data.cache_clusters:type_name -> encore.parser.meta.v1.CacheCluster
	...
	37, // 14: encore.parser.meta.v1.RPC.request_schema:type_name -> encore.parser.schema.v1.Type
	37, // 15: encore.parser.meta.v1.RPC.response_schema:type_name -> encore.parser.schema.v1.Type
	2,  // 16: encore.parser.meta.v1.RPC.proto:type_name -> encore.parser.meta.v1.RPC.Protocol
	38, // 17: encore.parser.meta.v1.RPC.loc:type_name -> encore.parser.schema.v1.Loc
	27, // 18: encore.parser.meta.v1.RPC.path:type_name -> encore.parser.meta.v1.Path
	12, // 19: encore.parser.meta.v1.RPC.tags:type_name -> encore.parser.meta.v1.Selector
	38, // 20: encore.parser.meta.v1.AuthHandler.loc:type_name -> encore.parser.schema.v1.Loc
	37, // 21: encore.parser.meta.v1.AuthHandler.auth_data:type_name -> encore.parser.schema.v1.Type
	37, // 22: encore.parser.meta.v1.AuthHandler.params:type_name -> encore.parser.schema.v1.Type
	9,  // 23: encore.parser.meta.v1.Middleware.name:type_name -> encore.parser.meta.v1.QualifiedName
	38, // 24: encore.parser.meta.v1.Middleware.loc:type_name -> encore.parser.schema.v1.Loc
	...
	12, // 36: encore.parser.meta.v1.MiddlewareDefNode.target:type_name -> encore.parser.meta.v1.Selector
	28, // 37: encore.parser.meta.v1.Path.segments:type_name -> encore.parser.meta.v1.PathSegment
	4,  // 38: encore.parser.meta.v1.Path.type:type_name -> encore.parser.meta.v1.Path.Type
	5,  // 39: encore.parser.meta.v1.PathSegment.type:type_name -> encore.parser.meta.v1.PathSegment.SegmentType
	6,  // 40: encore.parser.meta.v1.PathSegment.value_type:type_name -> encore.parser.meta.v1.PathSegment.ParamType
	9,  // 41: encore.parser.meta.v1.CronJob.endpoint:type_name -> encore.parser.meta.v1.QualifiedName
	37, // 42: encore.parser.meta.v1.PubSubTopic.message_type:type_name -> encore.parser.schema.v1.Type
	7,  // 43: encore.parser.meta.v1.PubSubTopic.delivery_guarantee:type_name -> encore.parser.meta.v1.PubSubTopic.DeliveryGuarantee
	32, // 44: encore.parser.meta.v1.PubSubTopic.publishers:type_name -> encore.parser.meta.v1.PubSubTopic.Publisher
	33, // 45: encore.parser.meta.v1.PubSubTopic.subscriptions:type_name -> encore.parser.meta.v1.PubSubTopic.Subscription
	35, // 46: encore.parser.meta.v1.CacheCluster.keyspaces:type_name -> encore.parser.meta.v1.CacheCluster.Keyspace
	34, // 47: encore.parser.meta.v1.PubSubTopic.Subscription.retry_policy:type_name -> encore.parser.meta.v1.PubSubTopic.RetryPolicy
	37, // 48: encore.parser.meta.v1.CacheCluster.Keyspace.key_type:type_name -> encore.parser.schema.v1.Type
