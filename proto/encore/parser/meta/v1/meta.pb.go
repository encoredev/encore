...
const (
	...
	Metric_HISTOGRAM Metric_MetricType = 2
)
...
type Metric struct {
	...
	Doc         string            `protobuf:"bytes,2,opt,name=doc,proto3" json:"doc,omitempty"`   // the doc string
	Type        Metric_MetricType `protobuf:"varint,3,opt,name=type,proto3,enum=encore.parser.meta.v1.Metric_MetricType" json:"type,omitempty"`
	ServiceName *string           `protobuf:"bytes,4,opt,name=service_name,json=serviceName,proto3,oneof" json:"service_name,omitempty"` // the service the metric is exclusive to, if any.
	LabelsType  *v1.Type          `protobuf:"bytes,5,opt,name=labels_type,json=labelsType,proto3" json:"labels_type,omitempty"`          // the labels struct type, or nil if no labels
}
...
func (x *Metric) GetLabelsType() *v1.Type {
	if x != nil {
		return x.LabelsType
	}
	return nil
...
var file_encore_parser_meta_v1_meta_proto_rawDesc = []byte{
	...
	0xc3, 0x05, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1f, 0x0a, 0x0b, 0x6d, 0x6f, 0x64, 0x75,
	...
	0x63, 0x68, 0x65, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x73, 0x12, 0x37, 0x0a, 0x07, 0x6d,
	0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x65,
	0x6e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x61, 0x72, 0x73, 0x65, 0x72, 0x2e, 0x6d, 0x65, 0x74,
	0x61, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x52, 0x07, 0x6d, 0x65, 0x74,
	0x72, 0x69, 0x63, 0x73, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x68, 0x61,
	...
	0x4c, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x54, 0x41, 0x47, 0x10, 0x02, 0x22, 0x63, 0x0a, 0x0b,
	...
	0x6e, 0x22, 0x9c, 0x05, 0x0a, 0x03, 0x52, 0x50, 0x43, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	0x65, 0x48, 0x00, 0x52, 0x0d, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x63, 0x68, 0x65,
	...
	0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x22, 0x2f, 0x0a, 0x0a, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	...
	0x43, 0x48, 0x45, 0x5f, 0x4b, 0x45, 0x59, 0x53, 0x50, 0x41, 0x43, 0x45, 0x10, 0x01, 0x22, 0x84,
	...
	0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x33, 0x0a, 0x0b, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x57, 0x49, 0x4c, 0x44, 0x43, 0x41, 0x52, 0x44, 0x10, 0x02, 0x22, 0x98, 0x01, 0x0a, 0x09, 0x50,
	...
	,
	...
	0x0b, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0xe8, 0x01, 0x0a,
	...
	0x79, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x1a, 0x70, 0x0a, 0x0b, 0x52, 0x65, 0x74, 0x72, 0x79,
	...
	0x45, 0x10, 0x01, 0x22, 0x9a, 0x03, 0x0a, 0x0c, 0x43, 0x61, 0x63, 0x68, 0x65, 0x43, 0x6c, 0x75,
	...
	0x22, 0x9a, 0x02, 0x0a, 0x06, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12,
	0x10, 0x0a, 0x03, 0x64, 0x6f, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x6f,
	0x63, 0x12, 0x3c, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0b, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x4e, 0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x3e, 0x0a, 0x0b, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	0x73, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x65,
	0x6e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x61, 0x72, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x63, 0x68,
	0x65, 0x6d, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0a, 0x6c, 0x61, 0x62,
	0x65, 0x6c, 0x73, 0x54, 0x79, 0x70, 0x65, 0x22, 0x33, 0x0a, 0x0a, 0x4d, 0x65, 0x74, 0x72, 0x69,
...
var file_encore_parser_meta_v1_meta_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_encore_parser_meta_v1_meta_proto_goTypes = []interface{}{
	...
	(Metric_MetricType)(0),             // 8: encore.parser.meta.v1.Metric.MetricType
	...
	(*v1.Decl)(nil),                    // 39: encore.parser.schema.v1.Decl
	(*v1.Type)(nil),                    // 40: encore.parser.schema.v1.Type
	(*v1.Loc)(nil),                     // 41: encore.parser.schema.v1.Loc
}
var file_encore_parser_meta_v1_meta_proto_depIdxs = []int32{
	39, // 0: encore.parser.meta.v1.Data.decls:type_name -> encore.parser.schema.v1.Decl
	...
	40, // 15: encore.parser.meta.v1.RPC.request_schema:type_name -> encore.parser.schema.v1.Type
	40, // 16: encore.parser.meta.v1.RPC.response_schema:type_name -> encore.parser.schema.v1.Type
	2,  // 17: encore.parser.meta.v1.RPC.proto:type_name -> encore.parser.meta.v1.RPC.Protocol
	41, // 18: encore.parser.meta.v1.RPC.loc:type_name -> encore.parser.schema.v1.Loc
	...
	41, // 21: encore.parser.meta.v1.AuthHandler.loc:type_name -> encore.parser.schema.v1.Loc
	40, // 22: encore.parser.meta.v1.AuthHandler.auth_data:type_name -> encore.parser.schema.v1.Type
	40, // 23: encore.parser.meta.v1.AuthHandler.params:type_name -> encore.parser.schema.v1.Type
	10, // 24: encore.parser.meta.v1.Middleware.name:type_name -> encore.parser.meta.v1.QualifiedName
	41, // 25: encore.parser.meta.v1.Middleware.loc:type_name -> encore.parser.schema.v1.Loc
	...
	40, // 44: encore.parser.meta.v1.PubSubTopic.message_type:type_name -> encore.parser.schema.v1.Type
	...
	8,  // 49: encore.parser.meta.v1.Metric.type:type_name -> encore.parser.meta.v1.Metric.MetricType
	40, // 50: encore.parser.meta.v1.Metric.labels_type:type_name -> encore.parser.schema.v1.Type
	37, // 51: encore.parser.meta.v1.PubSubTopic.Subscription.retry_policy:type_name -> encore.parser.meta.v1.PubSubTopic.RetryPolicy
	40, // 52: encore.parser.meta.v1.CacheCluster.Keyspace.key_type:type_name -> encore.parser.schema.v1.Type
	40, // 53: encore.parser.meta.v1.CacheCluster.Keyspace.value_type:type_name -> encore.parser.schema.v1.Type
	29, // 54: encore.parser.meta.v1.CacheCluster.Keyspace.path_pattern:type_name -> encore.parser.meta.v1.Path
