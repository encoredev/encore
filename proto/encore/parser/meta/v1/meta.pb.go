...
var file_encore_parser_meta_v1_meta_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x93, 0x04, 0x0a, 0x03, 0x52, 0x50,
	...
	0x31, 0x2e, 0x50, 0x61, 0x74, 0x68, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x2f, 0x0a, 0x0a,
	...
	0x55, 0x4c, 0x41, 0x52, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x52, 0x41, 0x57, 0x10, 0x01, 0x22,
	0xd5, 0x01, 0x0a, 0x0b, 0x41, 0x75, 0x74, 0x68, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x12,
	...
	0x65, 0x2e, 0x70, 0x61, 0x72, 0x73, 0x65, 0x72, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e,
	0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x63, 0x52, 0x03, 0x6c, 0x6f, 0x63, 0x12, 0x3a, 0x0a, 0x09, 0x61,
	...
	0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x63, 0x6c, 0x52, 0x08, 0x61,
	0x75, 0x74, 0x68, 0x44, 0x61, 0x74, 0x61, 0x22, 0xa4, 0x04, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x63,
	...
	0x44, 0x65, 0x66, 0x42, 0x09, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x22, 0x64,
	...
	0x73, 0x22, 0x9c, 0x01, 0x0a, 0x0b, 0x50, 0x61, 0x74, 0x68, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x33, 0x0a, 0x0b, 0x53,
...
var file_encore_parser_meta_v1_meta_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_encore_parser_meta_v1_meta_proto_goTypes = []interface{}{
	...
	(*Data)(nil),                 // 4: encore.parser.meta.v1.Data
	(*QualifiedName)(nil),        // 5: encore.parser.meta.v1.QualifiedName
	(*Package)(nil),              // 6: encore.parser.meta.v1.Package
	(*Service)(nil),              // 7: encore.parser.meta.v1.Service
	(*DBMigration)(nil),          // 8: encore.parser.meta.v1.DBMigration
	(*RPC)(nil),                  // 9: encore.parser.meta.v1.RPC
	(*AuthHandler)(nil),          // 10: encore.parser.meta.v1.AuthHandler
	(*TraceNode)(nil),            // 11: encore.parser.meta.v1.TraceNode
	(*RPCDefNode)(nil),           // 12: encore.parser.meta.v1.RPCDefNode
	(*RPCCallNode)(nil),          // 13: encore.parser.meta.v1.RPCCallNode
	(*StaticCallNode)(nil),       // 14: encore.parser.meta.v1.StaticCallNode
	(*AuthHandlerDefNode)(nil),   // 15: encore.parser.meta.v1.AuthHandlerDefNode
	(*Path)(nil),                 // 16: encore.parser.meta.v1.Path
	(*PathSegment)(nil),          // 17: encore.parser.meta.v1.PathSegment
	(*v1.Decl)(nil),              // 18: encore.parser.schema.v1.Decl
	(*v1.Loc)(nil),               // 19: encore.parser.schema.v1.Loc
}
var file_encore_parser_meta_v1_meta_proto_depIdxs = []int32{
	18, // 0: encore.parser.meta.v1.Data.decls:type_name -> encore.parser.schema.v1.Decl
	6,  // 1: encore.parser.meta.v1.Data.pkgs:type_name -> encore.parser.meta.v1.Package
	7,  // 2: encore.parser.meta.v1.Data.svcs:type_name -> encore.parser.meta.v1.Service
	10, // 3: encore.parser.meta.v1.Data.auth_handler:type_name -> encore.parser.meta.v1.AuthHandler
	5,  // 4: encore.parser.meta.v1.Package.rpc_calls:type_name -> encore.parser.meta.v1.QualifiedName
	11, // 5: encore.parser.meta.v1.Package.trace_nodes:type_name -> encore.parser.meta.v1.TraceNode
	9,  // 6: encore.parser.meta.v1.Service.rpcs:type_name -> encore.parser.meta.v1.RPC
	8,  // 7: encore.parser.meta.v1.Service.migrations:type_name -> encore.parser.meta.v1.DBMigration
	0,  // 8: encore.parser.meta.v1.RPC.access_type:type_name -> encore.parser.meta.v1.RPC.AccessType
	18, // 9: encore.parser.meta.v1.RPC.request_schema:type_name -> encore.parser.schema.v1.Decl
	18, // 10: encore.parser.meta.v1.RPC.response_schema:type_name -> encore.parser.schema.v1.Decl
	1,  // 11: encore.parser.meta.v1.RPC.proto:type_name -> encore.parser.meta.v1.RPC.Protocol
	19, // 12: encore.parser.meta.v1.RPC.loc:type_name -> encore.parser.schema.v1.Loc
	16, // 13: encore.parser.meta.v1.RPC.path:type_name -> encore.parser.meta.v1.Path
	19, // 14: encore.parser.meta.v1.AuthHandler.loc:type_name -> encore.parser.schema.v1.Loc
	18, // 15: encore.parser.meta.v1.AuthHandler.auth_data:type_name -> encore.parser.schema.v1.Decl
	12, // 16: encore.parser.meta.v1.TraceNode.rpc_def:type_name -> encore.parser.meta.v1.RPCDefNode
	13, // 17: encore.parser.meta.v1.TraceNode.rpc_call:type_name -> encore.parser.meta.v1.RPCCallNode
	14, // 18: encore.parser.meta.v1.TraceNode.static_call:type_name -> encore.parser.meta.v1.StaticCallNode
	15, // 19: encore.parser.meta.v1.TraceNode.auth_handler_def:type_name -> encore.parser.meta.v1.AuthHandlerDefNode
	2,  // 20: encore.parser.meta.v1.StaticCallNode.package:type_name -> encore.parser.meta.v1.StaticCallNode.Package
	17, // 21: encore.parser.meta.v1.Path.segments:type_name -> encore.parser.meta.v1.PathSegment
