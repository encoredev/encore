...
func (*PubSubTopic_RetryPolicy) Descriptor() ([]byte, []int) {
	return file_encore_parser_meta_v1_meta_proto_rawDescGZIP(), []int{18, 2}
}
...
var file_encore_parser_meta_v1_meta_proto_rawDesc = []byte{
	...
	0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0xe9, 0x06, 0x0a, 0x0b, 0x50, 0x75, 0x62, 0x53, 0x75,
...
var file_encore_parser_meta_v1_meta_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_encore_parser_meta_v1_meta_proto_goTypes = []interface{}{
	...
	(*PubSubTopic_RetryPolicy)(nil),    // 27: encore.parser.meta.v1.PubSubTopic.RetryPolicy
	(*v1.Decl)(nil),                    // 28: encore.parser.schema.v1.Decl
	(*v1.Type)(nil),                    // 29: encore.parser.schema.v1.Type
	(*v1.Loc)(nil),                     // 30: encore.parser.schema.v1.Loc
}
var file_encore_parser_meta_v1_meta_proto_depIdxs = []int32{
	28, // 0: encore.parser.meta.v1.Data.decls:type_name -> encore.parser.schema.v1.Decl
	...
	29, // 11: encore.parser.meta.v1.RPC.request_schema:type_name -> encore.parser.schema.v1.Type
	29, // 12: encore.parser.meta.v1.RPC.response_schema:type_name -> encore.parser.schema.v1.Type
	1,  // 13: encore.parser.meta.v1.RPC.proto:type_name -> encore.parser.meta.v1.RPC.Protocol
	30, // 14: encore.parser.meta.v1.RPC.loc:type_name -> encore.parser.schema.v1.Loc
	21, // 15: encore.parser.meta.v1.RPC.path:type_name -> encore.parser.meta.v1.Path
	30, // 16: encore.parser.meta.v1.AuthHandler.loc:type_name -> encore.parser.schema.v1.Loc
	29, // 17: encore.parser.meta.v1.AuthHandler.auth_data:type_name -> encore.parser.schema.v1.Type
	29, // 18: encore.parser.meta.v1.AuthHandler.params:type_name -> encore.parser.schema.v1.Type
	...
	29, // 31: encore.parser.meta.v1.PubSubTopic.message_type:type_name -> encore.parser.schema.v1.Type
	...
	27, // 35: encore.parser.meta.v1.PubSubTopic.Subscription.retry_policy:type_name -> encore.parser.meta.v1.PubSubTopic.RetryPolicy
