...
type Metric struct {
	...
	Labels      []*Metric_Label   `protobuf:"bytes,5,rep,name=labels,proto3" json:"labels,omitempty"`
}
...
var file_encore_parser_meta_v1_meta_proto_rawDesc = []byte{
	...
	0x22, 0xfa, 0x02, 0x0a, 0x06, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x6e,
...
var file_encore_parser_meta_v1_meta_proto_depIdxs = []int32{
	...
	39, // 50: encore.parser.meta.v1.Metric.labels:type_name -> encore.parser.meta.v1.Metric.Label
	...
	41, // 52: encore.parser.meta.v1.CacheCluster.Keyspace.key_type:type_name -> encore.parser.schema.v1.Type
	41, // 53: encore.parser.meta.v1.CacheCluster.Keyspace.value_type:type_name -> encore.parser.schema.v1.Type
	29, // 54: encore.parser.meta.v1.CacheCluster.Keyspace.path_pattern:type_name -> encore.parser.meta.v1.Path
	43, // 55: encore.parser.meta.v1.Metric.Label.type:type_name -> encore.parser.schema.v1.Builtin
