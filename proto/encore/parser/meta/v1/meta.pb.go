...
type RPC struct {
	...
	// OpenAPI tags for this endpoint, used for grouping in the OpenAPI specification.
	// These are separate from middleware tags.
	OpenapiTags   []string `protobuf:"bytes,20,rep,name=openapi_tags,json=openapiTags,proto3" json:"openapi_tags,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RPC) GetOpenapiTags() []string {
	if x != nil {
		return x.OpenapiTags
	}
	return nil
}
...
const file_encore_parser_meta_v1_meta_proto_rawDesc = "" +
	...
	"\rstatic_assets\x18\x13 \x01(\v2'.encore.parser.meta.v1.RPC.StaticAssetsH\x05R\fstaticAssets\x88\x01\x01\x12!\n" +
	"\fopenapi_tags\x18\x14 \x03(\tR\vopenapiTags\x1ac\n" +
	"\vExposeEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12>\n" +
	"\x05value\x18\x02 \x01(\v2(.encore.parser.meta.v1.RPC.ExposeOptionsR\x05value:\x028\x01\x1a\x0f\n" +
	"\rExposeOptions\x1a\xbd\x01\n" +
	"\fStaticAssets\x12 \n" +
	"\fdir_rel_path\x18\x01 \x01(\tR\n" +
	"dirRelPath\x120\n" +
	"\x12not_found_rel_path\x18\x02 \x01(\tH\x00R\x0fnotFoundRelPath\x88\x01\x01\x12-\n" +
	"\x10not_found_status\x18\x03 \x01(\rH\x01R\x0enotFoundStatus\x88\x01\x01B\x15\n" +
