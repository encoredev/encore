...
const file_encore_parser_schema_v1_schema_proto_rawDesc = "" +
	"\n" +
	"$encore/parser/schema/v1/schema.proto\x12\x17encore.parser.schema.v1\"\xca\x05\n" +
	"\x04Type\x126\n" +
	...
	"\aliteral\x18\n" +
	" \x01(\v2 .encore.parser.schema.v1.LiteralH\x00R\aliteral\x12R\n" +
	...
	"\x06cookie\x18\x03 \x01(\v2(.encore.parser.schema.v1.WireSpec.CookieH\x00R\x06cookie\x1a*\n" +
	"\x06Header\x12\x17\n" +
	...
	"\fIsValuesList\x18\x02 \x01(\bR\fIsValuesList*\xe5\x01\n" +
	"\aBuiltin\x12\a\n" +
	...
	"\x04UINT\x10\x13B(Z&encr.dev/proto/encore/parser/schema/v1b\x06proto3"
...
func file_encore_parser_schema_v1_schema_proto_init() {
	...
	file_encore_parser_schema_v1_schema_proto_msgTypes[16].OneofWrappers = []any{
		(*Literal_Str)(nil),
		(*Literal_Boolean)(nil),
		(*Literal_Int)(nil),
		(*Literal_Float)(nil),
	...
	file_encore_parser_schema_v1_schema_proto_msgTypes[20].OneofWrappers = []any{}
