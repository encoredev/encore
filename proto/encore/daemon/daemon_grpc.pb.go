...
func (c *daemonClient) DBProxy(ctx context.Context, in *DBProxyRequest, opts ...grpc.CallOption) (Daemon_DBProxyClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Daemon_serviceDesc.Streams[3], "/encore.daemon.Daemon/DBProxy", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *daemonClient) DBReset(ctx context.Context, in *DBResetRequest, opts ...grpc.CallOption) (Daemon_DBResetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Daemon_serviceDesc.Streams[4], "/encore.daemon.Daemon/DBReset", opts...)
	if err != nil {
		return nil, err
	}
